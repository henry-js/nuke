...
internal class Solution : Nuke.Common.ProjectModel.Solution
{
    ...
    public Project Nuke_Tooling_NuGet => SolutionFolder.GetProject("Nuke.Tooling.NuGet");
    public Project Nuke_Tooling_NuGet_Tests => SolutionFolder.GetProject("Nuke.Tooling.NuGet.Tests");
